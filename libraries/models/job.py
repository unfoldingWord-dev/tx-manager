...
class TxJob(App.Base, TxModel):
    ...
    created_at = Column(DateTime, default=datetime.utcnow, timezone=True, nullable=False)
    updated_at = Column(DateTime, default=datetime.utcnow, timezone=True, onupdate=datetime.utcnow, nullable=False)
    expires_at = Column(DateTime, nullable=True, timezone=True)
    started_at = Column(DateTime, nullable=True, timezone=True)
    ended_at = Column(DateTime, nullable=True, timezone=True)
    eta = Column(DateTime, nullable=True, timezone=True)
