...
class TestTaPreprocessor(unittest.TestCase):
    ...
    def test_ta_preprocessor(self):
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.out_dir, '1-intro.md')))
        self.assertTrue(os.path.isfile(os.path.join(self.out_dir, '2-process.md')))
        self.assertTrue(os.path.isfile(os.path.join(self.out_dir, '3-translate.md')))
        self.assertTrue(os.path.isfile(os.path.join(self.out_dir, '4-checking.md')))
        intro = read_file(os.path.join(self.out_dir, '1-intro.md'))
        process = read_file(os.path.join(self.out_dir, '2-process.md'))
        translate = read_file(os.path.join(self.out_dir, '3-translate.md'))
        checking = read_file(os.path.join(self.out_dir, '4-checking.md'))
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.out_dir, '4-checking-toc.yaml')))
        self.assertTrue(os.path.isfile(os.path.join(self.out_dir, '4-checking-config.yaml')))
