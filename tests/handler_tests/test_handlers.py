...
from functions.client_converter_callback.main import handle
from functions.client_linter_callback.main import handle
...
class TestHandlers(TestCase):
    ...
    def test_handlers(self, mock_handle_return_value):
        ...
        self.assertIsNone(functions.client_converter_callback.main.handle({}, {}))
        self.assertIsNone(functions.client_linter_callback.main.handle({}, {}))
