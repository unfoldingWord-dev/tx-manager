#!/usr/bin/env python
"""
Removes dummy data from manifest table starting from user1 repo1 until it can't find one in sequence
...
def remove_dummy_data_from_manifest_table(table_name):
    ...
    while delete_success:
        ...
        key = {'repo_name_lower': repo_name_lower, 'user_name_lower': user_name_lower}
